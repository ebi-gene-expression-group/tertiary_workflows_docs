...
You'll need to obtain access to the `documentation repository <https://github.com/ebi-gene-expression-group/tertiary_workflows_docs>`_ and make changes to documentation via pull requests to that repository.
